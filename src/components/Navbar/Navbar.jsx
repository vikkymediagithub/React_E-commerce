                ...
                <div className='hidden lg:block'>
                    <ul className='flex items-center gap-4'>
                        ...
                        <li className='relative cursor-pointer group'>
                            <a href="#" className='flex items-center gap-[2px] font-semibold text-gray-500 dark:hover:text-white py-2'>Help
                            <span>
                            ...
                            {/* Dropdown Links */}
                            <div className='absolute z-[9999] hidden group-hover:block w-[200] rounded-md bg-white shadow-md dark:bg-gray-900 p-2 dark:text-white'>
